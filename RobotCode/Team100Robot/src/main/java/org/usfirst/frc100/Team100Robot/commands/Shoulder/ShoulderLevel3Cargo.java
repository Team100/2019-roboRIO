...
public class ShoulderLevel3Cargo extends Command {
  boolean done;
  public ShoulderLevel3Cargo() {
  ...
  protected void initialize() {
    ...
    Robot.carriageShoulder.updateSetpoint(Robot.carriageShoulder.degreesToSetpointConverter(Robot.carriageShoulder.CARGO_LEVEL_3_SETPOINT));    
