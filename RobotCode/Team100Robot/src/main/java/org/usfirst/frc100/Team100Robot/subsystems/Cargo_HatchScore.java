 ...
 *
 */
public class Cargo_HatchScore extends Subsystem {
    ...
    public Cargo_HatchScore() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        topBallRollerShooter = new WPI_TalonSRX(4);
        
        
        
        bottomBallRollerShooter = new WPI_TalonSRX(5);
        
        
        
        loadingStationIntake = new Solenoid(0, 1);
        addChild("LoadingStationIntake",loadingStationIntake);
        
        
        hatchScorer = new Solenoid(0, 2);
        addChild("HatchScorer",hatchScorer);
        
        
        cargoScorer = new Solenoid(0, 3);
