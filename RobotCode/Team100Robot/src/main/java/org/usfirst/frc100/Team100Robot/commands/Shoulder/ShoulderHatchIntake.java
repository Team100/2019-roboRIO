...
public class ShoulderHatchIntake extends Command {
  boolean done;
  public ShoulderHatchIntake() {
  ...
  protected void initialize() {
    ...
    Robot.carriageShoulder.updateSetpoint(Robot.carriageShoulder.degreesToSetpointConverter(Robot.carriageShoulder.HATCH_INTAKE_SETPOINT));    
